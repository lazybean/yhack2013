YUI.add('yootravel-yql-fmt', function (Y) {
  Y.namespace('yootravel.yql').fmt = {
    ...
    getEanLandmarks: "http://api.ean.com/ean-services/rs/hotel/v3/geoSearch?cid=55505&apiKey=e89mfmwrj3xhtvjnemeq4t9q&destinationString={city}&type=2&countryCode={countryCode}&numberOfResults=5",
